  ...
  return (
    <div className="mm-discover">
      <header className="mm-discover-header">
        <div>
          <p className="mm-eyebrow">A guided conversation</p>
          <h1>Follow the live wire.</h1>
          <p>
            Start with something real. We’ll stay with one thread until the
            small, specific reward inside it becomes clear to you.
          </p>
        </div>
        <button
      ...
      <div className="mm-discovery-layout">
        <section className="mm-chat-shell">
          <div className="mm-chat-context">
            ...
            <div>
              <strong>Discovery guide</strong>
              <span>One question at a time</span>
            </div>
            <span className="mm-local-pill">Local workspace</span>
          </div>
        ...
        <aside className="mm-discovery-rail">
          ...
          <section className="mm-live-thread">
            ...
            >
              ...
              <div>
                <strong>Reconstructing the moment</strong>
                <p>
                  The conversation gathers lived evidence before it offers an
                  interpretation.
                </p>
              </div>
            </div>
