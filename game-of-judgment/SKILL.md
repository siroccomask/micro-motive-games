...
- Do not create the record until the user explicitly confirms that the micro-motive is accurate and complete.
...
Ask whether the statement feels accurate and complete. If the user hesitates, asks for a change, or supplies a qualifier, continue with one focused question at a time. The game ends only when the user explicitly confirms the final wording.
